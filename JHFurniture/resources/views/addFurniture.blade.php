                ...
                <div class="card">
                    ...
                    <form action="{{route('store.furniture')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="furnitureName" class="form-control" id="exampleInputEmail1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="furniturePrice" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="furnitureImage" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
